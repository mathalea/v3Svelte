...
<div class="flex flex-col space-y-4 ...">
  ...
  {#if exercice.besoinFormulaireNumerique}
    <div>
      ...
      <input type="number" class="w-16 border-2" min="1" max="{exercice.besoinFormulaireNumerique[1]}" data-bs-toggle="tooltip" title="{exercice.besoinFormulaireNumerique[2] || ''}" bind:value="{sup}" on:change="{nouveauxReglages}" />
    </div>
  {/if}
  {#if exercice.besoinFormulaireTexte}
    <div>
      {exercice.besoinFormulaireTexte[0]} : <input type="text" class="w-16 border-2" data-bs-toggle="tooltip" title="{exercice.besoinFormulaireTexte[1] || ''}" bind:value="{sup}" on:change="{nouveauxReglages}" />
    </div>
  {/if}
  ...
  {#if exercice.besoinFormulaire2Numerique}
    <div>
      ...
      <input type="number" class="w-16 border-2" min="1" max="{exercice.besoinFormulaire2Numerique[1]}" data-bs-toggle="tooltip" title="{exercice.besoinFormulaire2Numerique[2] || ''}" bind:value="{sup2}" on:change="{nouveauxReglages}" />
    </div>
  {/if}
  {#if exercice.besoinFormulaire2Texte}
    <div>
      {exercice.besoinFormulaire2Texte[0]} : <input type="text" class="w-16 border-2" data-bs-toggle="tooltip" title="{exercice.besoinFormulaire2Texte[1] || ''}" bind:value="{sup2}" on:change="{nouveauxReglages}" />
    </div>
  {/if}
  ...
  {#if exercice.besoinFormulaire3Numerique}
    <div>
      ...
      <input type="number" class="w-16 border-2" min="1" max="{exercice.besoinFormulaire3Numerique[1]}" data-bs-toggle="tooltip" title="{exercice.besoinFormulaire3Numerique[2] || ''}" bind:value="{sup3}" on:change="{nouveauxReglages}" />
    </div>
  {/if}
  {#if exercice.besoinFormulaire3Texte}
    <div>
      {exercice.besoinFormulaire3Texte[0]} : <input type="text" class="w-16 border-2" data-bs-toggle="tooltip" title="{exercice.besoinFormulaire3Texte[1] || ''}" bind:value="{sup3}" on:change="{nouveauxReglages}" />
    </div>
  {/if}
  ...
  {#if exercice.besoinFormulaire4Numerique}
    <div>
      ...
      <input type="number" class="w-16 border-2" min="1" max="{exercice.besoinFormulaire4Numerique[1]}" data-bs-toggle="tooltip" title="{exercice.besoinFormulaire4Numerique[2] || ''}" bind:value="{sup4}" on:change="{nouveauxReglages}" />
    </div>
  {/if}
  {#if exercice.besoinFormulaire4Texte}
    <div>
      {exercice.besoinFormulaire4Texte[0]} : <input type="text" class="w-16 border-2" data-bs-toggle="tooltip" title="{exercice.besoinFormulaire4Texte[1] || ''}" bind:value="{sup4}" on:change="{nouveauxReglages}" />
    </div>
  {/if}
</div>

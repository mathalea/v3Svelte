...
<footer class="w-full bg-white h-12 flex flex-row-reverse items-center bottom-0 opacity-100">
  <img class="px-6" style="height: 30px" src="/assets/images/logo2.png" alt="Logo Coopmaths 2" />
  ...
  <a class="pr-6 font-thin" href="mailto:contact@coopmaths.fr">contact@coopmaths.fr</a>

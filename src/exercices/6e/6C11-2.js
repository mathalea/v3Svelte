...
export default function VocabulaireDivisionEuclidienne() {
  ...
  this.besoinFormulaire3Numerique = ["Choix sur l'égalité", 2, "1 : Égalité classique (a=bq+r ou a=qb+r)\n2 : Égalité moins classique (par exemple, a=r+bq ou qb+r=a)\n3 : Mélange"]

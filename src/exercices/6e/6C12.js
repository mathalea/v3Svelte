...
export default class QuestionsPrix extends Exercice {
  ...
  nouvelleVersion() {
    ...
    for (let i = 0, texte, texteCorr, cpt = 0; i < this.nbQuestions && cpt < 50; ) {
      ...
      const NbArticles5 =
        choice(rangeMinMax(2, 9), [NbArticles, NbArticles2, NbArticles3, NbArticles4, NbArticles + NbArticles4, NbArticles2 + NbArticles4, NbArticles3 + NbArticles4, NbArticles4 + NbArticles4]) +
        NbArticles4
      ...
      for (let kk = 0; kk < QuestionsDisponibles.length; kk++) {
        if (QuestionsDisponibles.length > 1) {
        ...
        switch (QuestionsDisponibles[kk]) {
          ...
          case 2:
            ...
            break
          case 3:
            enonceAMC += `Si ${quidame} achetait ${ArticleIndef} ${ArticleSingulier} à $${texNombre3(PrixUnitaire)}$${sp()}€ l'unité puis d'autres articles pour $${texNombre3(
              AutrePrix
            )}$${sp()}€, quel serait le prix final${sp()}?<br><br>`
            ...
            break
          case 4:
            enonceAMC += `${quidame} dispose d'un bon de réduction de $${texNombre3(
              PrixReduction
            )}$${sp()}€. Si ${quidame} achetait ${ArticleIndef} ${ArticleSingulier}, quelle somme d'argent paierait ${quidame} au final${sp()}?<br><br>`
          ...
          case 7:
            ...
            if (this.sup3) {
              ...
              correctionAMC +=
                ...
                texteEnCouleurEtGras(`$${texNombre3(reponseAMC)}$`) +
                `${sp()}€.<br><br>`
            } else {
              reponseAMC = troncature(arrondi(PrixUnitaire / 10, 3) + 0.01, 2)
              correctionAMC += `$${texNombre3(PrixUnitaire)} \\div 10 \\approx ${texNombre3(arrondi(PrixUnitaire / 10, 3))}$ et $${texNombre3(
                troncature(arrondi(PrixUnitaire / 10, 3), 2)
              )} < ${texNombre3(arrondi(PrixUnitaire / 10, 3))} < ${texNombre3(reponseAMC)}$<br>`
              correctionAMC +=
          ...
          case 8:
            ...
            if (estentier(arrondi(PrixUnitaire * 100, 0) / (Nbpartage + 1))) {
              ...
              if (estentier(arrondi(PrixUnitaire * 1000, 0) / (Nbpartage + 1))) {
                correctionAMC += `$${texNombre3(PrixUnitaire)} \\div ${Nbpartage + 1} = ${texNombre3(arrondi(PrixUnitaire / (Nbpartage + 1), 3))}$ et $${texNombre3(
                  troncature(arrondi(PrixUnitaire / (Nbpartage + 1), 3), 2)
                )} < ${texNombre3(arrondi(PrixUnitaire / (Nbpartage + 1), 3))} < ${texNombre3(reponseAMC)}$<br>`
              } else {
                correctionAMC += `$${texNombre3(PrixUnitaire)} \\div ${Nbpartage + 1} \\approx ${texNombre3(arrondi(PrixUnitaire / (Nbpartage + 1), 3))}$ et $${texNombre3(
                  troncature(arrondi(PrixUnitaire / (Nbpartage + 1), 3), 2)
                )} < ${texNombre3(arrondi(PrixUnitaire / (Nbpartage + 1), 3))} < ${texNombre3(reponseAMC)}$<br>`
              }
              correctionAMC +=

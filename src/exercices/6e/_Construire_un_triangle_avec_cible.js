    ...
    for (let i = 0, texte, texteCorr, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      switch (listeTypeDeQuestions[i]) {
        ...
        case 6: // triangle ABC dont on connaît AB et AC et l'angle BAC
          ...
          cible = cibleRonde({ x: result[0], y: result[1], rang: 5, taille: 0.3 })
          objetsEnonce.push(cible, segmentAvecExtremites(A, B), polygoneAvecNom(A, B)[1])
          objetsEnonceml.push(codageAngle(B, A, CC, 1.1), afficheLongueurSegment(B, A), texteParPoint(nombreAvecEspace(Math.round(angle(B, A, C))) + '°', similitude(B, A, angle(B, A, C) / 2, 1 / lAB + 0.1)), afficheLongueurSegment(A, C, 'black', 1))
        ...
        case 7: // triangle ABC dont ont connais AB et les deux angles adjacents
          ...
          cible = cibleRonde({ x: result[0], y: result[1], rang: 5, taille: 0.3 })
          objetsEnonce.push(cible, segmentAvecExtremites(A, B), polygoneAvecNom(A, B)[1])
          objetsEnonceml.push(codageAngle(B, A, CC, 1.1), texteParPoint(nombreAvecEspace(Math.round(angle(B, A, C))) + '°', similitude(B, A, angle(B, A, C) / 2, 1 / lAB + 0.1)), codageAngle(A, B, CC, 1.1), texteParPoint(nombreAvecEspace(Math.round(angle(A, B, C))) + '°', similitude(A, B, -angle(A, B, C) / 2, 1 / lAB + 0.1)))
        ...
        case 9: // triangle ABC dont ont connais AB un angle adjacent et l'angle opposé
          ...
          cible = cibleRonde({ x: result[0], y: result[1], rang: 5, taille: 0.3 })
          objetsEnonce.push(cible, segmentAvecExtremites(A, B), polygoneAvecNom(A, B)[1])
          objetsEnonceml.push(codageAngle(B, A, CC, 1.1), afficheLongueurSegment(B, A), texteParPoint(nombreAvecEspace(Math.round(angle(B, A, C))) + '°', similitude(B, A, angle(B, A, C) / 2, 1 / lAB + 0.1)), codageAngle(A, CC, B, 1.1), texteParPoint(nombreAvecEspace(Math.round(angle(A, C, B))) + '°', similitude(A, CC, angle(A, CC, B) / 2, 1 / lAC + 0.1)))

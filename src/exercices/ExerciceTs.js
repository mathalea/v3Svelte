 ...
 * @author Rémi Angot
 */
export const uuid = '2b0ec'
export const ref = 'ExerciceTs'
export default class Exercice {
    ...
    contenuCorrection;
    autoCorrection;
    tableauSolutionsDuQcm;
    spacing;
    spacingCorr;
    pasDeVersionLatex;
    listePackages;
    consigneModifiable;
    nbQuestionsModifiable;
    nbCols;
    nbColsCorr;
    nbColsModifiable;
    nbColsCorrModifiable;
    spacingModifiable;
    spacingCorrModifiable;
    beamer;
    tailleDiaporama;
    nbQuestions;
    pointsParQuestions;
    ...
    mg32Editable;
    typeExercice;
    listeArguments; // Variable servant à comparer les exercices pour ne pas avoir deux exercices identiques
    nouvelleVersion() {
    }
    constructor() {
        // ////////////////////////////////////////////////
...
//# sourceMappingURL=ExerciceTs.js.map
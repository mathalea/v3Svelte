...
export default function EncadrementRacineCarree () {
  ...
  this.nouvelleVersion = () => {
    ...
    if (choice([true, false])) {
      ...
      this.question = `$a\\leqslant \\sqrt{${a}}\\leqslant b$ est un encadrement de $\\sqrt{${a}}$ par deux entiers consécutifs. <br> Quelle est la valeur de $a$ ? `
      ...
      this.question = `$a\\leqslant \\sqrt{${a}}\\leqslant b$ est un encadrement de $\\sqrt{${a}}$ par deux entiers consécutifs. <br> Quelle est la valeur de $b$ ? `

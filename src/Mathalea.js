...
export class Mathalea {
   ...
   */
    static async load(directory, filename) {
        try {
            ...
            if (directory !== 'exercicesStatiques') {
                ...
                const exercicePromise = new Exercice();
     ...
     */
    static async changeSettings(promiseExercice, settings) {
        const exercice = await promiseExercice;
        if (settings !== undefined) {
            if (settings.sup !== undefined)
                exercice.sup = settings.sup;
            if (settings.sup2 !== undefined)
                exercice.sup2 = settings.sup2;
            if (settings.sup3 !== undefined)
                exercice.sup3 = settings.sup3;
            if (settings.sup4 !== undefined)
                exercice.sup4 = settings.sup4;
            if (settings.nbQuestions !== undefined)
                exercice.nbQuestions = settings.nbQuestions;
            if (settings.seed !== undefined)
                exercice.seed = settings.seed;
        }
    }
    static renderDiv(div) {
...
//# sourceMappingURL=Mathalea.js.map